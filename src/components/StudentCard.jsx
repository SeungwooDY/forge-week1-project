    ...
    return (
        <div className="flex flex-col bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden transition-all duration-200">
            <div
                ...
                className="grid grid-cols-12 gap-4 items-center px-6 py-4 bg-white border border-slate-200 rounded-lg shadow-sm hover:border-slate-300 transition-colors duration-150 cursor-pointer"
            >
                ...
                <div className="col-span-3 min-w-0 text-sm text-slate-500">
                    {studentData.sid}
                </div>
                <div className="col-span-2 min-w-0 text-sm text-slate-500">
                    Grade {studentData.sgrade}
                </div>
